...
import {
  FormCustomerDetailsState,
  FormDesignState,
  FormResponseDetailsState,
  FormThanksState,
  FormWelcomeDetailsState,
} from "@/app/atoms";
    ...
    <div className="w-full min-h-screen">
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                ...
                />
                <button onClick={createNewForm} className="button">
      ...
      <div className="px-6 pb-12">
        <h1 className="text-lg font-medium">
          Your collection forms ({userForms?.length}){" "}
        </h1>
        {userForms?.length > 0 && (
          <div
            ...
            {userForms?.map((form: Form) => (
              <div key={form.id} className="form-item">
                ...
                <div className="border-t border-black/10 my-4 pt-4 flex space-x-2 items-center justify-between">
                      ...
                      <DialogHeader>
                        ...
                        <DialogDescription className="pt-4">
                          <div className="border border-black/10 rounded-lg py-2 px-2 mb-4">
                            <p className="text-gray-700 italic text-xs pb-1">
                          ...
                          <div className="border border-black/10 rounded-lg py-2 px-2">
                            <p className="text-gray-700 italic text-xs pb-2">
                  ...
                  <Link
                    href={`/forms/${form.id}/testimonials`}
                    className="formItem-option group"
                  >
